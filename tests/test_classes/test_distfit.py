...
def test_fit_dispatch_and_mse(normal_data, method, algorithm, target_mse):
    df = DistFit(normal_data, n=3)
    bez, mse = df.fit(method=method, algorithm=algorithm, max_iter_PG = 100)
